...
export default function Hero() {
  return (
    <section className="relative flex min-h-[900px] flex-col items-center overflow-hidden pt-[104px]">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
        src="/Homepage/Section 1/Header Images/526214caf79a7211f2ad2806141f3fa8.jpg"    alt="Hero background"
          fill
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex w-full max-w-[1280px] flex-col px-8 pb-[72px] pt-[52px]">

        {/* Main Heading */}
        <h1 className="font-sans text-[clamp(2.75rem,8vw,6.875rem)] font-semibold leading-[0.89] tracking-[-0.045em] text-black">
          <span className="block">Compare Flights, Hotels</span>
          <span className="block">&amp; Travel Deals</span>
        </h1>

        {/* Two-Column Layout */}
        <div className="mt-[36px] flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-end">

          {/* Left Column (Paragraph & Button) */}
          <div className="flex max-w-[330px] flex-col items-start gap-[24px]">
            ...
            <button className="group flex h-[44px] items-center gap-[10px] rounded-[14px] border border-[#e6e6e6] bg-white px-[18px] text-[14px] font-medium leading-[20px] tracking-[-0.02em] text-black transition-all hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.10)]">
              Compare Flights
          ...
          <div className="flex flex-col items-start gap-[24px] lg:items-end">
            ...
            <div className="flex items-end gap-[14px]">
              ...
              <div className="flex shrink-0 items-center">
                {[11, 12, 13, 14].map((imgId, index) => (
                  <div
                    key={imgId}
                    className={`flex size-[38px] items-center justify-center rounded-full bg-white p-[2px] ${index > 0 ? '-ml-4' : ''}`}
            ...
            <h2 className="font-sans text-[clamp(2.75rem,8vw,6.875rem)] font-semibold leading-[0.89] tracking-[-0.045em] text-black lg:text-right">
