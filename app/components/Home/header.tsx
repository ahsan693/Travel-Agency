...
export default function Header() {
  ...
  return (
    <header className="relative z-50 box-border w-full rounded-[24px] border border-white/55 bg-white/92 shadow-[0_18px_50px_rgba(16,24,40,0.08)] backdrop-blur-[18px]">
     <div className="mx-auto flex max-w-[1328px] items-center gap-6 box-border px-[22px] py-[14px] max-[1024px]:px-8 max-[430px]:px-4">
  ...
  <div className="flex items-center gap-10 ml-auto max-[1024px]:gap-7">
    <nav
    ...
    <Link
      href="/search-deals"
      className="flex shrink-0 items-center gap-2 whitespace-nowrap rounded-full bg-[#ffc629] px-5 py-3 text-sm font-semibold text-[#111111] transition-colors hover:bg-[#f5b800]"
    >
      Search Deals
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 11L11 3M11 3H4M11 3V10" stroke="#111111" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </Link>
  </div>
